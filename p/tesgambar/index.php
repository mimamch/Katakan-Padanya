...
<head>
    ...
    <link rel="stylesheet" href="../../assets/p/style.css?ver=2.8">
</head>
        ...
        <form action="" method="post">
            ...
            <div class="boxshare">
                <p class="share">Bagikan Ke :
                    <a href="whatsapp://send?text=Kirim Pesan Kepada Saya Tanpa Diketahui Disini <?php echo $share ?>" data-action="share/whatsapp/share" target="_blank"><img alt="Whatsapp" class="whatsappimg" src="https://katakanpadanya.tk/assets/p/whatsapp.png" width="90"></a>
