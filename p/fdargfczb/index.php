...
<head>
    ...
    <link rel="stylesheet" href="../../assets/p/style.css?ver=1.5">
</head>
...
<body>
    ...
    <div class='boxpesan'>
        <form action="" method="post">
            ...
            <<textarea rows="20" name="comment[text]" id="comment_text" cols="40" class="ui-autocomplete-input" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true"><?php echo $share ?></textarea>
