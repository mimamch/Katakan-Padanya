...
<body>
    ...
    <div class='boxpesan'>
        <form action="" method="post">
            ...
            <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $share ?>">Bagikan ke Facebook</a>
            <a href="whatsapp://send?text=GFG Example for whatsapp sharing <?php echo $share ?>" data-action="share/whatsapp/share" target="_blank">Bagikan ke Whatsapp Story</a>
            <div class='boxmsg'>
