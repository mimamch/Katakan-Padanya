...
<head>
    ...
    <link rel="stylesheet" href="../../assets/p/style.css?ver=2.0">
</head>
...
<body>
    ...
    <div class='boxpesan'>
        <form action="" method="post">
            ...
            <a class="share" href="whatsapp://send?text=Kirim Pesan Kepada Saya Tanpa Diketahui Disini <?php echo $share ?>" data-action="share/whatsapp/share" target="_blank">Bagikan ke Whatsapp Story |</a>
